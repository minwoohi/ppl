...
<header class="w3-display-container w3-center">
  ...
  <div class="mySlides w3-animate-opacity">
    ...
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Photos our web</h1>
        <hr class="w3-opacity">
        <p>team JM</p>
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="/ppl-admin/static/img/actor.PNG" alt="Image 2" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Photos our web</h1>
        <hr class="w3-opacity">
  ...
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="/ppl-admin/static/img/item.PNG" alt="Image 3" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Photos our web</h1>
        <hr class="w3-opacity">
